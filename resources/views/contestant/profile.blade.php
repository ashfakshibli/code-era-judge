          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                ...
                <li><a><b>Contest(s) Participated:</b> <span class="pull-right badge bg-aqua">5</span></a></li>
                <li><a><b>Problem(s) Solved:</b> <span class="pull-right badge bg-green">12</span></a></li>
                <li><a><b>Problem(s) Tried:</b> <span class="pull-right badge bg-blue">842</span></a></li>
              </ul>
            </div>
